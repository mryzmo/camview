...
file=sif('/media/sebastian/Katalys 2TB/desy17/20171030/lv/20171030_refl_14.sif')
...
#imagedata=np.swapaxes(file.readimg(1,16000),0,2)
imagedata=np.swapaxes(plifimg.readimgav(file,14500,15500,1),0,2)
